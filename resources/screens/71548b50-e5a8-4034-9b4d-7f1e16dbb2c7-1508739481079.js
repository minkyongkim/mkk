jQuery("#simulation")
  .on("click", ".s-71548b50-e5a8-4034-9b4d-7f1e16dbb2c7 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/31002e73-215c-4997-89c8-d7413281126a"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-71548b50-e5a8-4034-9b4d-7f1e16dbb2c7 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
