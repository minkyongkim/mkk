jQuery("#simulation")
  .on("click", ".s-afc21420-e363-48cc-a3d3-73da805ba083 .click", function(event, data) {
  ...
  .on("pageload", ".s-afc21420-e363-48cc-a3d3-73da805ba083 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
