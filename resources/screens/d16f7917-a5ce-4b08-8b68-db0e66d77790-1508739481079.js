jQuery("#simulation")
  .on("click", ".s-d16f7917-a5ce-4b08-8b68-db0e66d77790 .click", function(event, data) {
  ...
  .on("pageload", ".s-d16f7917-a5ce-4b08-8b68-db0e66d77790 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
