jQuery("#simulation")
  .on("click", ".s-a8fe7d37-331c-4bf6-a684-7b776bdbeb09 .click", function(event, data) {
  ...
  .on("pageload", ".s-a8fe7d37-331c-4bf6-a684-7b776bdbeb09 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
